          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
                ...
                <Link to="/login">
                  <Button size="lg" className="bg-[#B8960C] text-[#080808] hover:bg-[#D4AA10] rounded-xl px-10 h-13 font-semibold text-base">
                    Start Free <ChevronRight className="w-4 h-4 ml-1" />
                  </Button>
                </Link>
                <Link to="/Pricing">
                  <Button size="lg" variant="outline" className="rounded-xl px-8 h-13 border-[#2A2A2A] text-[#F8F8F8]/30 hover:border-[#B8960C]/30 hover:text-[#F8F8F8]/60">
                    View Plans
                  </Button>
                </Link>
              </motion.div>
