              ...
              <Link key={item.path} to={createPageUrl(item.path)}
                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all group ${
                  isActive
                    ...
                    ? "text-[#F8F8F8]/40 hover:text-[#F8F8F8]/70 hover:bg-[#2A2A2A]/30"
                    : "text-[#F8F8F8]/50 hover:text-[#F8F8F8] hover:bg-[#2A2A2A]/30"
                }`}>
                <item.icon className={`w-4 h-4 flex-shrink-0 ${isActive ? "text-[#B8960C]" : item.premium && !isPremium && !isCoach ? "text-[#F8F8F8]/30" : ""}`} />
