...
export default function Layout({ children }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#0A1628]">
      {/* Desktop sidebar */}
      <aside className="hidden md:flex flex-col w-60 bg-[#0F2035] border-r border-[#2A3F58]/50 min-h-screen fixed left-0 top-0 z-20">
        <div className="px-5 py-6 border-b border-[#2A3F58]/50">
              ...
              <Link key={item.path} to={createPageUrl(item.path)}
                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all group ${
                  isActive
                    ...
                    : "text-[#F8F8F8]/50 hover:text-[#F8F8F8] hover:bg-[#2A3F58]/30"
                }`}>
        ...
        <div className="px-3 py-4 border-t border-[#2A3F58]/50 space-y-1">
          {!isPremium && (
          ...
          <Link to="/Profile" className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all ${currentPath === "Profile" ? "text-[#B8960C] bg-[#B8960C]/10" : "text-[#F8F8F8]/50 hover:text-[#F8F8F8] hover:bg-[#2A3F58]/30"}`}>
      ...
      {/* Mobile bottom nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-[#0F2035] border-t border-[#2A3F58]/50 flex items-center justify-around px-2 py-2 safe-area-pb">
