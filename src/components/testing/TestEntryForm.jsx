    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {TESTS.map(t => (
            <div key={t.key} className="bg-[#080808] border border-[#2A2A2A] rounded-xl p-3">
      ...
      <Button type="submit" disabled={!hasValues || isLoading} className="bg-[#B8960C] text-[#080808] hover:bg-[#D4AA10] rounded-xl px-8">
