...
Provide ratings (excellent/good/average/below_average), top 2 strengths, top 2 areas to improve, and training recommendations.`,
  ...
  return (
    <div className="space-y-4">
      {!analysis && (
        <div className="bg-[#141414] border border-[#B8960C]/20 rounded-2xl p-5 text-center">
          ...
          <Button onClick={analyze} disabled={loading} className="bg-[#B8960C] text-[#080808] hover:bg-[#D4AA10] rounded-xl">
