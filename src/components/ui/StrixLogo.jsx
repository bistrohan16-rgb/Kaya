  ...
  return (
    <svg width={s} height={s} viewBox="0 0 40 40" fill="none"
      ...
      <line x1="20" y1="34" x2="20" y2="8"
        stroke="#B8960C" strokeWidth="2" strokeLinecap="round" />

      {/* Left branch — curves up and outward */}
      <path d="M20 22 C16 19 10 17 8 13"
        stroke="#B8960C" strokeWidth="1.8" strokeLinecap="round" fill="none" />
      ...
      <path d="M20 15 C17 13 13 11 11 8"
        stroke="#B8960C" strokeWidth="1.2" strokeLinecap="round" fill="none" opacity="0.6" />
      ...
      {/* Root dot — the source */}
      <circle cx="20" cy="34" r="2" fill="#B8960C" />

      {/* Apex dot — the reaching point */}
      <circle cx="20" cy="8" r="1.5" fill="#B8960C" opacity="0.7" />
    </svg>
  );
}
...
export function KayaWordmark({ className = "" }) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <KayaMark size={32} />
      <span className="font-display text-2xl font-semibold tracking-[0.2em] text-[#F8F8F8] uppercase">Kaya</span>
    </div>
  );
}
